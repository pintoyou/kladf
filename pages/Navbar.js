              ...
              Dashboard
                        ...
                        {account ? (
                            <Link
                                ...
                                <button className="bg-gradient-to-r from-linear-x to-linear-y hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4  ml-[16px]  rounded-[50px]">
                                    {account.slice(0, 5) + '...' + account.slice(38, 42)}
                                </button>

                            </Link>
                        ) : (
                            <button onClick={web3Handler} className="bg-gradient-to-r from-linear-x to-linear-y hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4  ml-[16px]  rounded-[50px]">Connect Wallet</button>
                        )}
